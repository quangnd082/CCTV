...
class CaptureButton(QPushButton):
    def __init__(self,  parent=None):
        ...
        self.default_size = QSize(60, 60)  # Kích thước ban đầu của nút bấm
        self.hover_size = QSize(80, 80)  # Kích thước khi đưa chuột vào
        self.default_icon_size = QSize(45, 45)  # Kích thước ban đầu của nút bấm
        self.hover_icon_size = QSize(55, 55)  # Kích thước khi đưa chuột vào

        self.setIcon(QIcon("assets/capture.png"))  # Thêm icon vào nút
        self.setIconSize(self.default_icon_size)  # Kích thước icon
        self.setFixedSize(self.default_size)  # Đặt kích thước ban đầu của nút

    def enterEvent(self, event):
        # Khi chuột vào nút, tăng kích thước
        self.setFixedSize(self.hover_size)
        self.setIconSize(self.hover_icon_size)
        super().enterEvent(event)

    def leaveEvent(self, event):
        # Khi chuột rời nút, trở về kích thước ban đầu
