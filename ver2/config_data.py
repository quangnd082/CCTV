...
class ConfigInfo:
    def __init__(self, no_of_camera, max_column, camera_infos, max_active_cameras=4):
        self.no_of_camera = no_of_camera
        self.max_column = max_column
        self.camera_infos = camera_infos
        self.max_active_cameras = int(max_active_cameras)
    ...
    def from_dict(cls, config_info):
        ...
        max_active = config_info.get('max_active_cameras', config_info.get('no_of_camera', 4))
        return cls(
            config_info['no_of_camera'],
            config_info['max_column'],
            camera_infos,
            max_active_cameras=max_active,
        )
